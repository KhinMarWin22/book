...
const BooklistsComponents = ({data}) => {
  return (
   <div className='  w-[340px] h-[490px]  rounded-lg '>
     <div className="max-w-sm rounded border overflow-hidden shadow-lg">
        <Link to={`/detail/${data.id}`}>
        <img className=" w-full h-[400px]     hover:opacity-60 hover:scale-105 duration-500     rounded-t-lg   "  src={data.image} alt="Sunset in the mountains" /></Link>
